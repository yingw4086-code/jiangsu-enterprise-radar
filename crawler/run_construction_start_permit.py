...
from data_source.construction_start_permit import (
    PERMIT_TYPE,
    ConstructionStartPermitCrawler,
)
...
DEFAULT_CLOUD_PATH = PROJECT_ROOT / "data" / "cloud" / "construction_start_permits.json"


def run(args: argparse.Namespace) -> dict[str, object]:
    crawler = ConstructionStartPermitCrawler(
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="采集并严格筛选海门建设工程施工许可证")
